...
export default function Hero() {
  const words = [
    ...
    "React.js & Microservices Developer",
    "Competitive Programmer | 200+ LeetCode",
  ];

  const [code] = useState(`
const profile = {
    name: 'Shivansh Mishra',
    title: 'Full-Stack Developer | Java & Spring Boot | Problem Solver',
    skills: [
        'Java', 'Spring Boot', 'Spring Security', 'Hibernate',
        'React.js', 'MySQL', 'REST APIs', 'Microservices',
        'Tailwind CSS', 'Git', 'Maven', 'Postman'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  ...
                  Crafting scalable architectures and clean code 💻✨
                </p>
              </div>
              ...
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-brain"></i>&nbsp;&nbsp;DSA & Logic
                </div>
              </div>
            </div>
